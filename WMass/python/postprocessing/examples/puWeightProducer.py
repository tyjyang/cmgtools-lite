...
pufile_mc="%s/src/CMGTools/WMass/python/postprocessing/data/pileup/MyMCPileupHistogram_2016Legacy.root" % os.environ['CMSSW_BASE']
pufile_data="%s/src/CMGTools/WMass/python/postprocessing/data/pileup/MyDataPileupHistogram_2016Legacy.root" % os.environ['CMSSW_BASE']
...
puWeight = lambda : puWeightProducer(pufile_mc,pufile_data,"Pileup_nTrueInt_Wplus","pileup",name="puw",verbose=True)
