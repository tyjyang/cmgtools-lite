...
## usage:
## python resultPlots.py --config results_config_mu.txt --outdir <outputdirectory>
...
if __name__ == '__main__':
    ...
    for t in toysHessian:
        ...
        cmd += ' -y {cd}/binningYW.txt --infile {inf} --outdir {od} --type {t} --suffix floatingPOIs_nobbb_{t} '.format(cd=results['cardsdir'],od=tmp_outdir, t=t, inf=results['both_floatingPOIs_'+t])
        os.system(cmd)
        cmd += ' --normxsec '
        os.system(cmd)
