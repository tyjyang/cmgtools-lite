...
if [[ "${useDataGH}" == "y" ]]; then
    ...
    MCweigthOption=" -W 'puw2016_nTrueInt_36fb(nTrueInt)*LepGood_SF1[0]*LepGood_SF3[0]' "
...
do
	...
	if [[ "${regionKey[${region}]}" == "FRclosureMC" ]]; then       
		...
		regionCommand="${regionCommand} --xp WandZ,TauDecaysW,WFlips"	
	    fi
