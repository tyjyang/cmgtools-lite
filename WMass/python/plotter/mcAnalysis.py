...
def addMCAnalysisOptions(parser,addTreeToYieldOnesToo=True):
    ...
    parser.add_argument("--mcTruth-scale-factor-file", dest="mcTruthScaleFactorFile", type=str, default="./testMuonSF/mcTruthEff_Zplus_customNano_trackInfoAndGlobalMuons.root", help="File to be used for tests with scale factors (it enables additional histograms that may often need to be customized)")
