...
// Fri Oct 23 14:02:27 2020 by ROOT version 6.10/09
// from TTree Events/Events
// found on file: /eos/cms/store/cmst3/group/wmass/w-mass-13TeV/NanoAOD/WplusJetsToMuNu_TuneCP5_13TeV-powhegMiNNLO-pythia8-photos/NanoAODv7/201022_231658/0000/SMP-RunIISummer16NanoAODv7-00336_497.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Int_t           GenPart_genPartIdxMother[128];   //[nGenPart]
   Int_t           GenPart_pdgId[128];   //[nGenPart]
   Int_t           GenPart_status[128];   //[nGenPart]
   Int_t           GenPart_statusFlags[128];   //[nGenPart]
   ...
   Float_t         Jet_chFPV0EF[21];   //[nJet]
   Float_t         Jet_chFPV1EF[21];   //[nJet]
   Float_t         Jet_chFPV2EF[21];   //[nJet]
   Float_t         Jet_chFPV3EF[21];   //[nJet]
   ...
   Float_t         Jet_cRegCorr[21];   //[nJet]
   Float_t         Jet_cRegRes[21];   //[nJet]
...
#ifdef nanoaodV7_cxx
nanoaodV7::nanoaodV7(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/eos/cms/store/cmst3/group/wmass/w-mass-13TeV/NanoAOD/WplusJetsToMuNu_TuneCP5_13TeV-powhegMiNNLO-pythia8-photos/NanoAODv7/201022_231658/0000/SMP-RunIISummer16NanoAODv7-00336_497.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/eos/cms/store/cmst3/group/wmass/w-mass-13TeV/NanoAOD/WplusJetsToMuNu_TuneCP5_13TeV-powhegMiNNLO-pythia8-photos/NanoAODv7/201022_231658/0000/SMP-RunIISummer16NanoAODv7-00336_497.root");
      }
...
Int_t nanoaodV7::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t nanoaodV7::LoadTree(Long64_t entry)
{
...
void nanoaodV7::Init(TTree *tree)
{
...
void nanoaodV7::Show(Long64_t entry)
{
...
Int_t nanoaodV7::Cut(Long64_t entry)
{
