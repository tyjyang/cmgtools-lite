...
if __name__ == "__main__":
    ...
    parser.add_option('-a', '--make-asymmetry', dest="makeAsymmetry", action="store_true", default=False, help="Make ratio of difference over the sum. For this to make sense, the binning of the two inputs must be consistent")
