...
parser.add_option('--dressed', default=False, action='store_true', help='use dressed lepton and W instead of preFSR (default %default)')
(options, args) = parser.parse_args()

typeString = 'dressed' if options.dressed else 'preFSR'
