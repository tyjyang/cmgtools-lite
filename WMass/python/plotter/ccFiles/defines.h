...
typedef enum {isoTrigPlus=0, isoTrigMinus, isoNotrig, noisoTrigPlus, noisoTrigMinus, noisoNotrig, antiisoTrigPlus, antiisoTrigMinus, antiisoNotrig, trackingAndReco, isoTrigPlusStepOfTnp, isoNotrigStepOfTnP} ScaleFactorType; // to use product
