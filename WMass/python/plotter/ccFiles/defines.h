...
typedef enum {isoTrigPlus=0, isoTrigMinus, isoNotrig, noisoTrigPlus, noisoTrigMinus, noisoNotrig, antiisoTrigPlus, antiisoTrigMinus, antiisoNotrig, trackingAndReco, isoTrigPlusStepOfTnp, isoNotrigStepOfTnP, tracking, altTracking, reco, altReco, global} ScaleFactorType; // to use product
