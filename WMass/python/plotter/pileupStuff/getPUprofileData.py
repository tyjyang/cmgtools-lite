...
for era in eras:
    cmd = f"pileupCalc.py -i lumiStuff/NanoAOD_json_Run2016{era}_GoldenJsonFilter.txt --inputLumiJSON {pileupFile} --calcMode true --minBiasXsec 69200 --maxPileupBin 100 --numPileupBins 100 pileupStuff/pileupProfileData_2016Legacy_Run{era}.root"
    print(cmd)
